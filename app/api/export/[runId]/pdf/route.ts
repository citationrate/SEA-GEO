...
<div class="avi-box">
  ${[
    { label: "Presence (35%)", val: (a.presence_score ?? 0) * 100 },
    { label: "Rank (25%)", val: (a.rank_score ?? 0) * 100 },
    { label: "Sentiment (20%)", val: (a.sentiment_score ?? 0) * 100 },
    { label: "Stability (20%)", val: (a.stability_score ?? 0) * 100 },
  ].map((c) => `
  <div class="bar-row">
