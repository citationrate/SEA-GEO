  ...
  return (
    <div className="min-h-screen bg-dots flex items-center justify-center p-4 relative" style={{ background: "var(--background)" }}>
      ...
      <div className="relative w-full max-w-sm animate-fade-in">
        ...
        {/* Card */}
        <div className="card">
          <h1 className="font-display text-lg text-foreground mb-1" style={{ fontWeight: 300 }}>Bentornato</h1>
          <p className="text-sm text-muted-foreground mb-6 font-sans">Accedi al tuo account SeaGeo</p>
          <LoginForm />
        </div>
