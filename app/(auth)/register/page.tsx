  ...
  return (
    <div className="min-h-screen bg-dots flex items-center justify-center p-4 relative" style={{ background: "var(--background)" }}>
      ...
      <div className="relative w-full max-w-sm animate-fade-in">
        ...
        {/* Card */}
        <div className="card">
          <h1 className="font-display text-lg text-foreground mb-1" style={{ fontWeight: 300 }}>Crea il tuo account</h1>
          <p className="text-sm text-muted-foreground mb-6 font-sans">Inizia a misurare la tua visibilità AI</p>
          <RegisterForm />
        </div>
