      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
            ...
            <Line type="monotone" dataKey="presence" name="Presence" stroke="var(--success)" strokeWidth={1.5} dot={{ r: 3 }} />
            <Line type="monotone" dataKey="sentiment" name="Sentiment" stroke="var(--accent)" strokeWidth={1.5} dot={{ r: 3 }} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
