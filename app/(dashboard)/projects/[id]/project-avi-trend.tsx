...
function shortModelName(model: string): string {
  // Brand AI (ChatGPT, Gemini, Claude, Perplexity, Grok) per la legenda
  // del trend. modelIdToBrand è la source-of-truth condivisa con altre
  // UI (filter Sources, run report, datasets, competitors).
  return modelIdToBrand(model)?.brand ?? model;
}
