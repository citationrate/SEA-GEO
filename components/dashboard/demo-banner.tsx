...
export function DemoBanner({ plan }: { plan: string }) {
  ...
  return (
    <div
      ...
      style={{ background: "linear-gradient(135deg, rgba(212,168,23,0.08), rgba(212,168,23,0.03))", borderColor: "rgba(212,168,23,0.2)" }}
    >
      <div className="flex items-center gap-3 min-w-0">
        <Sparkles className="w-4 h-4 text-[#d4a817] shrink-0" />
      ...
      <div className="flex items-center gap-2 shrink-0">
        <Link
          href="/piano"
          className="text-xs font-medium px-3 py-1.5 rounded-[2px] bg-[#d4a817] text-white hover:bg-[#d4a817]/80 transition-colors whitespace-nowrap"
        >
          Vedi i piani &rarr;
        </Link>
        <button
