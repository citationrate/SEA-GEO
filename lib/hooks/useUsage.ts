...
const DEFAULTS: UsageData = {
  ...
  noBrowsingPromptsUsed: 0, noBrowsingPromptsLimit: 8, noBrowsingPromptsRemaining: 8, noBrowsingUnlimited: false,
  ...
  promptsUsed: 0, promptsLimit: 8, promptsRemaining: 8,
  refetch: async () => {},
};
